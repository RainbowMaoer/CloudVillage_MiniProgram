...
__DEFINE__(1663337367957, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1663337367958,"./event-store":1663337367959}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1663337367958, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1663337367959, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1663337367958,"./utils":1663337367960}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1663337367960, function(require, module, exports) {
...
return __REQUIRE__(1663337367957);
})()
